...
class NotificationController extends Controller
{
    ...
    public function updateEligibility(Request $request, int $id): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'course_cpi_mode' => 'nullable|in:all,individual',
            'course_cpi_default' => 'nullable|numeric|min:0|max:10',
            'phd_allowed' => 'boolean',
        ...
        $eligibility = $notification->eligibilityCriteria()->updateOrCreate(
            ...
            [
                ...
                'course_cpi_required' => $validated['course_cpi_required'] ?? false,
                'course_cpi_mode' => $validated['course_cpi_mode'] ?? null,
                'course_cpi_default' => $validated['course_cpi_default'] ?? null,
