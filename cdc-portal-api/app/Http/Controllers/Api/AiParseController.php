...
Extract these fields:
{
  ...
  "course_cpi_required": "boolean or null — true only if the document explicitly mentions different CPI/CGPA cutoffs per course/discipline/branch",
  "course_cpi_mode": "one of: all | individual (or null). Use 'all' if one CPI cutoff applies to all selected courses, 'individual' if multiple different course/discipline CPIs are mentioned",
  "course_cpi_default": "float or null — if course_cpi_mode is 'all', the CPI cutoff value that should apply to all selected courses",
