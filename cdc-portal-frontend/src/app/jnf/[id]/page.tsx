...
import { Box, Typography, Tabs, Tab, Button, CircularProgress, Grid, TextField, MenuItem, Autocomplete, Chip, Checkbox, FormControlLabel, FormGroup, Switch, Divider, Collapse, IconButton, Snackbar, Alert, Dialog, DialogTitle, DialogContent, DialogActions, RadioGroup, Radio, FormLabel } from '@mui/material';
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: `repeat(${JNF_TABS.length}, 1fr)` }, gap: 0, position: 'relative' }}>
            ...
            {JNF_TABS.map((label, i) => {
              ...
              if (formData) {
                ...
                else if (i === 2) isSaved = Object.keys(formData.salary_details || {}).length > 0;
